...
public class YonghuweishengView extends YonghuweishengEntity implements Serializable {
	...
	public YonghuweishengView() {

	}

	public YonghuweishengView(YonghuweishengEntity yonghuweishengEntity) {
		try {
			BeanUtils.copyProperties(this, yonghuweishengEntity);
