    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">宿舍卫生管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">宿舍卫生列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">宿舍卫生列表</h3>
...
<script>
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("susheweisheng/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addsusheweisheng", "addsusheweisheng");
        window.location.href = "add-or-update.jsp"
    }
